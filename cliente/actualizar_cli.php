        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Actualiza Cliente</div>
                                    <center>
                                    <div class="col-md-5">
                                    <?php
             ...
             $row = $result->fetch_assoc();
                 ?>
                                              <form action="proceso_actualiza_cli.php?dni_cliente=<?php echo $row['dni_cliente']; ?>" method="POST" enctype="multipart/form-data">
                                                  <div>
                                                  <label for="exampleInputruc_cliente" >Ruc Cliente</label>
                                                       <input type="text" REQUIRED   name="ruc_cliente" value="<?php echo $row['ruc_cliente'];?>"/>
                                                   </div>
                                                  <div>
                                                   <label for="exampleInputnombre_cliente" >Nombre Cliente</label>
                                                       <input type="text" REQUIRED  name="nombre_cliente" value="<?php echo $row['nombre_cliente'];?>"/>
                                                   </div>
                                                   <div>
                                                   <label for="exampleInputapellido_cliente" >Apellidos</label>
                                                       <input type="text" REQUIRED   name="apellido_cliente" value="<?php echo $row['apellido_cliente'];?>"/>
                                                   </div>
