...
<html lang="en">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Agregar Cliente</div>
                                    <center>
                                    <div class="col-md-5">
                                          <h3>Agregar Nuevo Cliente</h3>
                                              <form action="aceptar_cli.php" method="POST" enctype="multipart/form-data">
                                                     <div>
                                                       <label for="exampleInputdni_cliente" >DNI Cliente</label>
                                                       <input type="text" REQUIRED  name="dni_cliente" placeholder="DNI Cliente"/>
                                                      </div>
                                                      <div>
                                                   <label for="exampleInputruc_cliente" >Ruc Cliente</label>
                                                       <input type="text" REQUIRED   name="ruc_cliente" placeholder="Ruc Cliente"/>
                                                   </div>
                                                  <div>
                                                   <label for="exampleInputnombre_cliente" >Nombre Cliente</label>
                                                       <input type="text" REQUIRED  name="nombre_cliente" placeholder="Nombre Cliente"/>
                                                   </div>
                                                   <div>
                                                   <label for="exampleInputapellido_cliente" >Apellidos</label>
                                                       <input type="text" REQUIRED   name="apellido_cliente" placeholder="Apellidos"/>
                                                   </div>
  ...
  <td><th><button><a href="actualizar_cli.php?dni_cliente=<?php echo $row['dni_cliente']; ?>">actualizar</a></button> </th>
      <th><button><a href="eliminar_cli.php?dni_cliente=<?php echo $row['dni_cliente']; ?>">eliminar</a></button></th>
       <!--<th><button class="detalle-btn"><a class="detalle-a" href="login.php?accion=A&codigo=<?php echo $row['codigo']; ?>" >Actualizar</a></button></th>
       <th><button class="detalle-btn"><a class="detalle-a" href="login.php?accion=E&codigo=<?php echo $row['codigo']; ?>">Eliminar</a></button></th>--></td>
</tr>
<?php
            }
           ?>
